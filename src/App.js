    ...
    return (
      <div className="container App">
        <h1>
          ...
          <a href="https://github.com/53Lab/github-contributors-map-web" target="_blank">
        ...
        <div className="footer">
          <iframe 
            src="https://ghbtns.com/github-btn.html?user=53Lab&repo=github-contributors-map-web&type=star&count=true&size=large"
            frameBorder="0" scrolling="0" width="160px" height="30px">
          </iframe>

          <iframe 
            src="https://ghbtns.com/github-btn.html?user=53Lab&repo=github-contributors-map-web&type=fork&count=true&size=large"
